        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between flex-wrap gap-2">
            <Link href={`/profile/${post.profiles.username}`} className="flex items-center gap-2 group">
              <Avatar name={post.profiles.display_name || post.profiles.username} url={post.profiles.avatar_url} program={post.profiles.program} position={post.profiles.avatar_position} size={22} />
